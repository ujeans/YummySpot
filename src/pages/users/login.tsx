...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col justify-center px-8 lg:px-8 h-[60vh]">
      <div className="mx-auto w-full max-w-sm">
        <div className="navbar__logo text-center text-2xl font-semibold">
          YummySPOT
        </div>
        <div className="text-center mt-6 text-xl font-bold text-gray-600">
          SNS 계정으로 로그인해주세요
        </div>
